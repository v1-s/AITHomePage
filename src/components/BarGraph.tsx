...
const BarGraph: React.FC = () => {
  ...
  return (
    <div className="mx-auto w-full lg:w-4/5 px-2 my-20 text-center">
      <h3 className="text-xl md:text-3xl font-bold text-center mb-6 font-bold text-center relative element inline-block mx-auto after:bottom-N20">IT Industry Trends (2020-2024)</h3>

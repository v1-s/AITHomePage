...
const CommunityGuidelines = () => (
  <div>
    <section>
      <h4 className="font-semibold mt-2 text-md text-md md:text-md text-mainblue">AchieversIt Community Platform User Terms and Conditions</h4>
      <h4 className="font-semibold mt-2 text-md text-mainblue text-md md:text-md ">Definitions</h4>
      <p className="text-xs md:text-md">
        For the purposes of this Platform User Terms and Conditions –<br />
        <b>“Applicable Law(s)” </b>mean and includes all applicable statutes, enactments, acts of legislature, laws, ordinances, rules, bye-laws, regulations, notifications, guidelines, policies, directions, circulars, press notes, directives and orders of any court, government, statutory authority, board (in each such case whether preliminary or final), and, if applicable, international treaties and regulations and all amendments thereto from time to time.<br />
        <b>“Affiliate”</b> means any entity that directly or indirectly controls, is controlled by, or is under common control with the subject entity. “Control,” for purposes of this definition, means direct or indirect ownership or control of more than 50% of the voting interests of the subject entity.<br />
        <b>“User” or “You”</b> refers to any user (individual or otherwise) of the Platform and its related services.<br />
        <b>“Minimum Age” </b>means more than 18 years old. However, if the Applicable Law requires that You must be older in order to use the Platform without parental consent (including using of your personal data) then the Minimum Age is such older age.<br />
        <b>“Content”</b> means and includes videos, audio (for example music and other sounds), graphics, photos, text (such as comments and scripts), branding (including trade names, trademarks, service marks, or logos), data, database, tags, labels, text, questions, lectures, quiz, graphics, diagrams, concepts, diagram, trainings, reviews, comments, suggestions, ideas, audio and/or visual animations or illustrations, options, solutions, answer keys, hints, representations, prints, audio and/or visual representations generated optically, electronically, digitally or by any other means.
      </p>

      <h4 className="font-semibold mt-2 text-md text-mainblue text-md">I. Conditions relating to Your Use of the Platform</h4>
      <h5 className="font-semibold mt-2 text-md text-md">1. Your User Account:</h5>
      <p className="leading-custom text-xs md:text-md text-xs md:text-md">
        If You use the Platform, You are responsible for maintaining the confidentiality of Your User account and password and for restricting access to Your computer to prevent unauthorised access to Your User account. You agree to accept responsibility for all activities that occur under Your User account or password. You should take all necessary steps to ensure that Your User account password is kept confidential and secured and should inform us immediately if you have any reason to believe that Your User account and/or password has become known to anyone else, or if the password is being, or is likely to be, used in an unauthorised manner. To use Platform, You agree and acknowledge that: (1) Your User account information is truthful and correct; (2) You fulfil the Minimum Age criteria; (3) You are not already restricted by the Platform from using the Platform and its related services; (4) You will use Your User account solely for education purposes and not for any business or commercial purposes; (5) You will only publish Content or information on the Platform that does not violate the Applicable Law nor any third-party rights (including intellectual property rights, right to privacy, etc.). (6) Nothing contained in the Platform Terms and Conditions shall create an employment, agency, partnership or joint venture relationship between Us and You in relation to Your usage of the Platform and its related services. We reserve the right to refuse access to the Platform, terminate or suspend Your User account, remove or edit Content publish by Your User account at any time without notice to You, in case Your are in breach of these Platform Terms and Conditions.
      </p>

      <h5 className="font-semibold mt-2 text-md text-md">2. Community Platform for Communication and Educational Purposes:</h5>
      <p className="leading-custom text-xs md:text-md text-xs md:text-md">
      ...
      <h5 className="font-semibold mt-2 text-md text-md">3. Access to Platform:</h5>
      <p className="leading-custom text-xs md:text-md text-xs md:text-md">
      ...
      <h5 className="font-semibold mt-2 text-md">6. Privacy Notice:</h5>
      <p className="leading-custom text-xs md:text-md">
      ...
      <h5 className="font-semibold mt-2 text-md">7. Your Conduct and Obligations:</h5>
      <p className="leading-custom text-xs md:text-md">
        The Platform is not for use by anyone under the Minimum Age (defined). You should not create a fake User someone else, or any other image that is not your likeness, for Your User account photo. Creating a User account with misleading information about your identity or any other aspect of personal information is considered a violation of the Platform Terms and Conditions. Do not spam, harass, abuse, or otherwise violate any third party’s rights through Your use of the Platform and its related services.
      </p>
    </section>
  </div>
);

...
const CommunityGuidelines = () => (
  <div>
    <section>
      <h4 className="font-semibold mt-2 text-md md:text-md text-mainblue">AchieversIt Community Platform User Terms and Conditions</h4>
      <h4 className="font-semibold mt-2 text-md md:text-md text-mainblue">Definitions</h4>
      ...
      <h4 className="font-semibold mt-2 text-mainblue text-md">I. Conditions relating to Your Use of the Platform</h4>
      <h5 className="font-semibold mt-2 text-md">1. Your User Account:</h5>
      ...
      <h5 className="font-semibold mt-2 text-md">2. Community Platform for Communication and Educational Purposes:</h5>
      <p className="leading-custom text-xs md:text-md">
      ...
      <h5 className="font-semibold mt-2  text-md">3. Access to Platform:</h5>
      <p className="leading-custom text-xs md:text-md">

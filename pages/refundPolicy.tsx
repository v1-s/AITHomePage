...
const RefundPolicy = () => (
  <div>
    <section>
      ...
      <h4 className="font-semibold mt-2 text-md text-mainblue">For Instructor-Led Training:</h4>
      <p className="leading-custom text-xs md:text-md">To qualify for a refund, you must:</p>
      <ul className="list-disc pl-6 mt-2">
        <li className="text-xs md:text-sm">Submit your refund request within 7 days of purchasing your course.</li>
        <li className="text-xs md:text-sm">Have consumed less than 25% of the video-learning content.</li>
        <li className="text-xs md:text-sm">Have not attended more than one (1) live online class.</li>
        <li className="text-xs md:text-sm">Not have requested any exam voucher or kit.</li>
      </ul>
      <p className="leading-custom text-xs md:text-sm">
        Any refund request failing to meet all of these requirements will not be accepted and no refund will be provided.
      </p>

      <h4 className="font-semibold mt-2 text-mainblue text-md">University Partnered Programs / Bootcamps:</h4>
      ...
      <h4 className="font-semibold mt-2 text-mainblue md:text-md " >For Instructor-Led Training & University Partnered Programs:</h4>
      <p className="leading-custom text-xs md:text-sm">
        Simplilearn reserves the right to reschedule/cancel a class/session due to any unavoidable circumstances. Simplilearn will reschedule any cancelled class/session.
      </p>

      <h4 className="font-semibold mt-2 text-mainblue text-sm md:text-md ">Cancellation & Refunds: For CSM, CSPO, PSM, PSPO Programs:</h4>
      <p className="leading-custom  text-xs md:text-md">
      ...
      <ul className="list-disc pl-6 mt-2">
        <li className="text-xs md:text-sm">Not have attended any classes.</li>
        <li className="text-xs md:text-sm">Submit your refund request within 7 days of purchasing a course.</li>
      </ul>

      <h4 className="font-semibold mt-2 text-mainblue text-sm md:text-md">Refund Request Process:</h4>
      <p className="leading-custom text-xs md:text-md">Refund request can be initiated in two ways:</p>
      <ul className="list-disc pl-6 mt-2">
        <li className="text-xs md:text-sm">From the My Orders section, by clicking on Initiate Refund for the relevant course. This will work when item purchase-quantity is one.</li>
        <li className="text-xs md:text-sm">In case item purchase-quantity is more than one, please reach out to our support team through our Help & Support section on the website.</li>
      </ul>

      <h4 className="font-semibold mt-2 text-mainblue text-md md:text-md ">Refunds: Duplicate Payment:</h4>
      <p className="leading-custom text-xs md:text-md">
